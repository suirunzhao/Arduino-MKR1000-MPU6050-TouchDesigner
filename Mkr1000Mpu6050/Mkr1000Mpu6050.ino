...
//    Serial.println("MPU6050 connection failed. Retrying to initialize...");
//    accelgyro.initialize();
    delay(1000);
  }
  ...
  */
  ...
  int countdown = 5; //how many seconds before we start streaming

  while (countdown) {
    Serial.print("Streaming wil start in ");
